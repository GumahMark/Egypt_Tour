...
export default function Navbar() {
  ...
  return (
    <nav className="w-full h-24 flex flex-col justify-center items-center lg:bg-transparent bg-[url('/src/assets/home.jpg')] bg-cover lg:relative fixed z-20">
      <div className="container mx-auto lg:px-6">
        <div className="lg:w-full w-11/12 mx-auto h-full flex justify-between items-center">
          ...
          <ul className="flex-1 flex justify-center items-center gap-16 max-lg:hidden">
            ...
            <a href="#" className="leading-normal text-lg  no-underline text-white"> Galleries</a>
        ...
        {dropdown ? (
          ...
          className="lg:hidden w-full h-full fixed top-24 bg-[url('/src/assets/home.jpg')] bg-cover ease-in-out duration-100"
          >
